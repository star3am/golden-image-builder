...
source "azure-arm" "windows-2022" {
  ...
  managed_image_name                = "windows-2022"
...
source "googlecompute" "windows-2022" {
  ...
  image_name          = "windows-2022-${local.version_number}"
  ...
  image_family = "soe-windows-2022"
}

source "vagrant" "windows-2022" {
  source_path = "jborean93/WindowsServer2022"
  provider    = "virtualbox"
  ...
  output_dir      = "${var.build_directory}/windows-2022/vagrant"
}
...
build {
  sources = ["source.azure-arm.windows-2022", "source.amazon-ebs.windows-2022", "source.googlecompute.windows-2022", "source.vagrant.windows-2022"]

  provisioner "powershell" {
    script = "./packer/windows/windowsserver/scripts/ConfigureRemotingForAnsible.ps1"
    only   = ["azure-arm.windows-2022"]
  }
  ...
  provisioner "powershell" {
    ...
    only = ["googlecompute.windows-2022"]
  }
}
